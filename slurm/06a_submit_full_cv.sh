#!/bin/bash
#SBATCH --output=/cluster/home/t144807uhn/logs/chip-stroma-analysis/full_cv/%x/%x_%j.out
#SBATCH --error=/cluster/home/t144807uhn/logs/chip-stroma-analysis/full_cv/%x/%x_%j.err
...
export WANDB_DIR="/cluster/home/t144807uhn/logs/chip-stroma-analysis/wandb/full_cv/$1/task_${SLURM_ARRAY_TASK_ID}"
mkdir -p "$WANDB_DIR"
...
srun python scripts/06_full_cv.py \
