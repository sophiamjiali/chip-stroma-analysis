#!/bin/bash
#SBATCH --output=/cluster/home/t144807uhn/logs/chip-stroma-analysis/evaluate/%x/%x_%j.out
#SBATCH --error=/cluster/home/t144807uhn/logs/chip-stroma-analysis/evaluate/%x/%x_%j.err
...
mkdir -p /cluster/home/t144807uhn/logs/chip-stroma-analysis/evaluate/$1
...
srun python -u scripts/08_evaluate.py \
